...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  setNetworkEnabled(e) {
    ...
    this.ai.enqueueAndForget((async () => {
      this.started && await this.Vi();
    })));
  }
  /**
  ...
  async shutdown() {
    ...
    await this.Ai.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], ((e) => {
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  ys(e) {
    ...
    if (t.storageArea === this.storage) {
      ...
      this.ai.enqueueRetryable((async () => {
        if (this.started) {
          if (null !== t.key) {
            if (this.Cs.test(t.key)) {
              ...
              await Promise.all(e2.map(((e3) => this.syncEngine.Xs(e3))));
            }
          }
        } else this.Ss.push(t);
      }));
...
var __PRIVATE_BundleLoader = class {
   ...
   */
  async complete() {
    const e = await __PRIVATE_localStoreApplyBundledDocuments(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.ua.id), t = this.la(this.documents);
...
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    ...
    if (n2 && 0 !== n2.length) {
      ...
      for (const e3 of n2) {
        const t3 = r.va.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
...
function __PRIVATE_syncEngineLoadBundle(e, t, n) {
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      let s = await t2.$a();
      for (; s; ) {
        const e3 = await i.ca(s);
        e3 && n2._updateProgress(e3), s = await t2.$a();
      }
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e), await this.Ua.initialize(this, e), // Enqueue writes from a previous session
    await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Ua.syncEngine), await __PRIVATE_fillWritePipeline(this.Ua.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
    // set it after localStore / remoteStore are started.
    await this.persistence.pi((() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve())));
  }
  createLocalStore(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
  }
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  async initialize(e) {
    ...
    // set it after localStore / remoteStore are started.
    await this.persistence.pi((async (e2) => {
      await __PRIVATE_syncEngineApplyPrimaryState(this.Ua.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
    }));
  }
  createSharedClientState(e) {
...
var __PRIVATE_BundleReaderImpl = class {
  ...
  async $a() {
    return await this.getMetadata(), this.Ha();
  }
  /**
  ...
  async Za(e) {
    for (; this.buffer.length < e; ) {
      await this.eu() && this.Ya("Reached the end of bundle when more is expected.");
    }
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    ...
    const t = await (async function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
      ...
      }, i = await n.No("BatchGetDocuments", n.serializer.databaseId, ResourcePath.emptyPath(), r, t2.length), s = /* @__PURE__ */ new Map();
      i.forEach(((e3) => {
  ...
  async commit() {
    ...
    e.forEach(((e2, t) => {
      ...
      await n.Fo("Commit", n.serializer.databaseId, ResourcePath.emptyPath(), r);
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget((async () => (function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    ...
    n.Ga(), e.asyncQueue.enqueueAndForget((async () => (function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
